        ...
        For i As Integer = 0 To p_clbLayer.CheckedItems.Count - 1
            Select Case p_clbLayer.CheckedItems.Item(i) '.SelectedItem '.GetItemText(i) clbLayer.CheckedItems.Item(1)
                ...
                Case "Areas Restringidas"
                    ...
                    If pFeatureLayer.Name = "Zona Reservada" Then
                        pFeatureLayer.Name = "Areas Restringidas"
                        pMxDoc.ActiveView.Refresh()
                        pMxDoc.UpdateContents()
                    End If
                    cls_Catastro.Color_Poligono_Simple(m_application, "Areas Restringidas")
                Case "Zonas Urbanas"
                    ...
                    'Dim cadenazona As String        'variable agregada para capturar zona
                    If pFeatureLayer.Name = "Zona Urbana" Then
                        pFeatureLayer.Name = "Areas Urbanas"
                        pMxDoc.ActiveView.Refresh()
                        pMxDoc.UpdateContents()
                    End If


                    cls_Catastro.Color_Poligono_Simple(m_application, "Areas Urbanas")
                Case "Catastro Minero"
                    ...
                    If pFeatureLayer.Name = "Catastro" Then
                        pFeatureLayer.Name = "Catastro Minero"
                        pMxDoc.ActiveView.Refresh()
                        pMxDoc.UpdateContents()
                    End If

                    cls_Catastro.Color_Poligono_Simple(m_application, "Catastro Minero")

                    'Agrega capa catastro de jeruapa para comparar con capa catastro geodatabase (valido para ver si estan reducciones)
                    ...
                    strLayerPath = glo_pathStyle_acceditario & carpeta_datum & "\cata" & p_Zona & ".lyr"
